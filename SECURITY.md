...
- **GitHub Security Advisories** — [open a private report](https://github.com/semitexa/semitexa-mail/security/advisories/new).
...
In scope: anything in `semitexa/mail` that lets a request, a job or a message do
